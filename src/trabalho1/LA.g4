...
//Especifica um programa na linguagem LA que é composto por: 
//declarações de variáveis, palavras reservadas, um corpo de comandos 
//encerrada pela palavra "fim_algoritmo".
//Na parte semântica temos empilhamento de uma tabela contento as variáveis globais
//e no final o desempilhamento, desta.
